...
public class memberRepository {
    ...
    public void InsertDB(RegistModel registModel){
        ...
        String sql = "INSERT INTO member (username,password,name,birth,cellphone,email,address,meter,adpExp)" +
                "VALUES('" + registModel.getUsername() + "','" + registModel.getPassword() + "','" + registModel.getName() + "','" + registModel.getBirth() + "','" + registModel.getPhone() + "','" + registModel.getEmail() + "','" + registModel.getAddress() + "'," + m + ",'" + registModel.getAdpExp() + "');";
